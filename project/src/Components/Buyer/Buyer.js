...
export default function Buyer() {
  ...
  const buyerAddHandler = (newBuyer) => {
    fetch("http://localhost:3001/buyer", {
      ...
      .then(() => {
        alert(
          "Buyer " + newBuyer.firstName + " " + newBuyer.surname + " added."
        );
      });
  };
  ...
  function handleDelete(buyerId, buyerFname, buyerLname) {
    ...
    if (confirmDelete) {
      fetch(`http://localhost:3001/buyer/${buyerId}`, {
        ...
        .then((buyerToDelete) => {
          dispatch({ type: "REMOVE", payload: buyerToDelete });
        })
      ...
      <div>
        <ul className={"custom-list"} data-cy="buyerDetails">
          {buyersList.map((buyer) => (
            <>
              <li key={buyer.id}>
                <div className={"buyerBlock bg-dark-subtle"}>
                  {" "}
                ...
                <div className={"float-end"}>
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleDelete(buyer.id, buyer.firstName, buyer.surname)
                    }
                  >
      ...
      {show && (
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            <form className={"bg-light text-dark"}>
              ...
              <input
                ...
                id={"fname"}
                defaultValue={buyerToEdit.firstName}
                ref={firstNameRef}
              ...
              <input
                ...
                className="form-control"
                id={"sname"}
                defaultValue={buyerToEdit.surname}
                ref={surnameRef}
              ...
              <input
                ...
                className="form-control"
                id={"address"}
                defaultValue={buyerToEdit.address}
                ref={addressRef}
              ...
              <input
                ...
                className="form-control"
                id={"postcode"}
                defaultValue={buyerToEdit.postcode}
                ref={postcodeRef}
              ...
              <input
                ...
                className="form-control"
                id={"phone"}
                defaultValue={buyerToEdit.phone}
                ref={phoneRef}
          ...
          <Modal.Footer>
            ...
            <Button
              variant="primary"
              onClick={() => handleUpdate(buyerToEdit.id)}
